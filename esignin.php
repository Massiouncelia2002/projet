...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title> connexion de l'Admin </title>
          ...
          <div class="animated-form">
            ...
            <?php include('uerrors.php'); ?>
              <div class="form-group">
                <label for="uname"><i class="fas fa-user-shield"></i></i>Nom d'utilisateur</label>
            ...
            <div class="form-group">
              ...
              <div class="form-group flex-end">
                <button type="submit" class="button" name="dbutton"><i class="fas fa-database"></i>Acceder a la BDD</button>
              </div>
              </div>
              <div class="col">
              <div class="form-group flex-end">
                <button type="submit" class="button" name="pbutton"><i class="fas fa-search"></i>recherche des passagers</button>
              </div>
              </div>
              </div>
